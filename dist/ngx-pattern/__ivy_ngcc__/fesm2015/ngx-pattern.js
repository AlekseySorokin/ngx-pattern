...
NgxPatternDirective.ɵfac = function NgxPatternDirective_Factory(t) { return new (t || NgxPatternDirective)(ɵngcc0.ɵɵdirectiveInject(ElementRef), ɵngcc0.ɵɵdirectiveInject(NgControl, 8)); };
NgxPatternDirective.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: NgxPatternDirective, selectors: [["", "ngxPattern", ""]], hostBindings: function NgxPatternDirective_HostBindings(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵlistener("input", function NgxPatternDirective_input_HostBindingHandler() { return ctx.onInput(); })("drop", function NgxPatternDirective_drop_HostBindingHandler($event) { return ctx.onDrop($event); });
    } }, inputs: { ngxPattern: "ngxPattern" }, features: [ɵngcc0.ɵɵNgOnChangesFeature] });
__decorate([
    Input()
...
NgxPatternDirective = __decorate([ __param(0, Inject(ElementRef)), __param(1, Optional()), __param(1, Inject(NgControl))
], NgxPatternDirective);
